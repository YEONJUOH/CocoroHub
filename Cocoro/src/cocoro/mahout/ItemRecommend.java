...
public class ItemRecommend {
	...
	public static void main(String[] args) throws IOException, NamingException {
		...
		try {
			...
			// AbstractJDBCDataModel dm = new MySQLJDBCDataModel();

			DataModel dm = new FileDataModel(
					new File("C:/Users/Choi Ji Woong/git/CocoroHub/Cocoro/data/recommend.csv"));
			...
			// recommendation.getItemID() 이게 비교한 아이디
			// recommendation.getValue()) 유사성의 값이다 \
